...
Public transportation is a lifeline for many residents across America, providing access to jobs, education,
healthcare, and daily necessities. However, the quality of transit service varies substantially across
communities. Data from the region shows a clear relationship between socioeconomic factors
and transit burden. This repository contains a Python-based statistical and QGIS geospatial analysis of transit inequity across four major U.S. cities: Boston, Washington DC, New York City, and Seattle. Using U.S. Census block-group datasets from 2019 to 2023 and custom demographic GeoPackages that were built for each city, the notebook quantifies poverty levels, extreme commute burden, and the statistical relationships between these variables.
